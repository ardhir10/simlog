...
<head>
    ...
    <title>{{$data->nomor_rk}} (Usulan Kebutuhan)</title>
    <style>
        .title{
            /* margin-top: -10px; */
        }
        ...
        <div class="main">
            ...
            <div class="title" >
                <div style="text-align: center;">
                    <span style="font-weight:bold;display:block;">USULAN PERMINTAAN KEBUTUHAN BARANG</span>
                    {{-- <span style="font-weight:bold;">{{$data->nomor_rk}}</span> --}}
                            ...
                            <tbody>
                                @foreach ($data->barang_diminta as $item)
                                    <tr>
                                        ...
                                        <td style="width: 265px">{{$item->barang->nama_barang ?? $item->nama_barang}}</td>
                                        <td>{{$item->barang->kode_barang ?? $item->kode_barang}}</td>
            ...
            <table style="">
                <tr>
                    ...
                    <td style="width: auto;padding-right:10px;">
                        <div style="text-align: center;">
                            <div style="margin-bottom:18px;">
                                <span style="display: block;font-size: 12px;white-space:nowrap">Disetujui Oleh</span>
                            </div>
