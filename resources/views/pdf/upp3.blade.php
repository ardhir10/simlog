            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    <div style="padding-left:20px;width:100%">
                        <div>
                            <span style="font-size:2vw;font-size: 35px;display:block;font-weight:bolder; ">KEMENTERIAN
                                PERHUBUNGAN</span>
                            <span style="font-size: 1vw;font-size:23px;display:block;font-weight:bolder; ">DIREKTORAT
                                JENDERAL PERHUBUNGAN LAUT</span>
                            <span style="font-size: 1vw;font-size:24.5px;display:block;font-weight:bolder; ">DISTRIK
                                NAVIGASI KELAS I TANJUNG PRIOK</span>
                        </div>
                        <div>
                                    ...
                                    <td style="vertical-align: top;">
                                        <div style="padding-left:10px;">
                                            <table style="">
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('/images/icon/browser.png') }}" width="10"
                                                            alt="">
                                                        {{-- <img src="{{ public_path('/images/icon/browser.png') }}"
                                                        width="10" alt=""> --}}
                                                    </td>
                                                    <td>: <span
                                                            style="font-size: 10px">https://hubla.dephub.go.id/disnavtanjungpriok</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('/images/icon/mail.png') }}" width="10"
                                                            alt="">
                                                        {{-- <img src="{{ public_path('/images/icon/mail.png') }}"
                                                        width="10" alt=""> --}}
        ...
        <div class="main">
            ...
            <div class="middle">
                ...
                <div style="text-align:center;width:100%">
                    <table class="table">
                        <thead>
                            <tr class="tr-head" style="background: #1E1E1E;color:white;font-weight:bold;">
                        ...
                        <tr>
                            <td style="width: auto;padding-right:10px;" width="auto">
                                <div style="text-align: center;">
                                    ...
                                    {!! '<img
                                        src="data:image/png;base64,' . DNS2D::getBarcodePNG(route('public-data.user',$data->user_id ?? 0), 'QRCODE',2.5,2.5) . '"
                                        alt="barcode" />' !!}
                                    <span style="display: block;font-size: 12px;">{{$data->user->name ?? '-'}}</span>
                                    <span
                                        style="display: block;font-size: 12px;">{{$data->user->role->name ?? '-'}}</span>
                                    <span
                                        style="display: block;font-size: 10px;">{{$data->tanggal_permintaan ?? '-'}}</span>
                                </div>
                            </td>
                            <td style="width: auto;padding-right:10px;">
                                <div style="text-align: center;">
                                    ...
                                    {!! '<img
                                        src="data:image/png;base64,' . DNS2D::getBarcodePNG(route('public-data.user',$data->approvals->where('type','Disetujui Kadisnav')->first()->approve_by_id ?? 0), 'QRCODE',2.5,2.5) . '"
                                        alt="barcode" />' !!}
                                    <span style="display: block;font-size: 12px;">Kepala Distrik</span>
                                    <span style="display: block;font-size: 12px;">Navigasi</span>
                                    <span
                                        style="display: block;font-size: 10px;">{{$data->approvals->where('type','Disetujui Kadisnav')->first()->timestamp ?? '-'}}</span>
                                    @else
                            ...
                            <td style="width: auto;padding-right:10px;">
                                <div style="text-align: center;">
                                    ...
                                    {!! '<img
                                        src="data:image/png;base64,' . DNS2D::getBarcodePNG(route('public-data.user',$data->approvals->where('type','Disetujui Kabid Logistik')->first()->approve_by_id ?? 0), 'QRCODE',2.5,2.5) . '"
                                        alt="barcode" />' !!}
                                    <span style="display: block;font-size: 12px;">Kepala Bidang</span>
                                    <span style="display: block;font-size: 12px;">Logistik</span>
                                    <span
                                        style="display: block;font-size: 10px;">{{$data->approvals->where('type','Disetujui Kabid Logistik')->first()->timestamp ?? '-'}}</span>
                                    @else
                                    <img src="{{asset('images/icon/nay.png')}}" height="72" alt="">
                                            ...
                                            <tr>
                                                <td style="padding-right: 10px;">
                                                    <div style="text-align: center">
                                                        ...
                                                        @if ($data->approvals->where('type','Disetujui Kasie
                                                        Pengadaan')->first())
                                                        {!! '<img
                                                            src="data:image/png;base64,' . DNS2D::getBarcodePNG(route('public-data.user',$data->approvals->where('type','Disetujui Kasie Pengadaan')->first()->approve_by_id ?? 0), 'QRCODE',2.5,2.5) . '"
                                                            alt="barcode" />' !!}
                                                        <span style="display: block;font-size: 12px;">Kasie</span>
                                                        <span style="display: block;font-size: 12px;">Pengadaan</span>

                                                        <span
                                                            style="display: block;font-size: 10px;">{{$data->approvals->where('type','Disetujui Kasie Pengadaan')->first()->timestamp ?? '-'}}</span>
                                                        @else
                                                        <img src="{{asset('images/icon/nay.png')}}" height="72" alt="">
                                                        <span style="display: block;font-size: 12px;">Kasie</span>
                                                        <span style="display: block;font-size: 12px;">Pengadaan</span>
                                                ...
                                                <td>
                                                    <div style="text-align: center">
                                                        @if ($data->approvals->where('type','Disetujui Bendahara
                                                        Materil')->first())
                                                        {!! '<img
                                                            src="data:image/png;base64,' . DNS2D::getBarcodePNG(route('public-data.user',$data->approvals->where('type','Disetujui Bendahara Materil')->first()->approve_by_id ?? 0), 'QRCODE',2.5,2.5) . '"
                                                            alt="barcode" />' !!}
                                                        <span style="display: block;font-size: 12px;">Bendahara</span>
                                                        <span style="display: block;font-size: 12px;">Materil</span>

                                                        <span
                                                            style="display: block;font-size: 10px;">{{$data->approvals->where('type','Disetujui Bendahara Materil')->first()->timestamp ?? '-'}}</span>
                                                        @else
                                                        <img src="{{asset('images/icon/nay.png')}}" height="72" alt="">
                                                        <span style="display: block;font-size: 12px;">Bendahara</span>
                                                        <span style="display: block;font-size: 12px;">Materil</span>
