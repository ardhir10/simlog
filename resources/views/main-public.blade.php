...
/*
        ...
        .datatables thead tr td:first-child {
            border-top-left-radius:  10px !important;
            border-bottom-left-radius:  10px !important;
        }
        .datatables thead tr td:first-child {
        ...
        .datatables thead tr td:last-child {
            border-top-right-radius:  10px !important;
            border-bottom-right-radius:  10px !important;
        }
        ...
        .bg-success {
            background-color: #11CA1F !important;
        }
...
<body style="background: #ECECEC;" data-sidebar-size="lg" class="sidebar-enable">
