    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('rk-approval.kabid-logistik-setuju',$data->id)}}" method="post">
                    @csrf
                ...
                <form action="{{route('rk-approval.kabid-logistik-disposisi',$data->id)}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="disposisi_ke" id="" class="form-select">
                                <option value="Kasie Pengadaan">Kasie Pengadaan</option>
                                <option value="Kasie Inventaris">Kasie Inventaris</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="">Keterangan</label>
    ...
    <div id="setujuDisposisiKadisnav" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('rk-approval.kabid-logistik-setuju-disposisi-kadisnav',$data->id)}}" method="post">
                    @csrf
    ...
    <div id="modalSerahkanBarang" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('rk-approval.serahkan-barang',$data->id)}}" method="post">
                    @csrf
