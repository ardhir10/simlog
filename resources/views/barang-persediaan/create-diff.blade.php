        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('barang-persediaan.create-diff',Request::get('id')) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        @if (Request::get('sumber_barang') == 'existing')
                            @include('barang-persediaan.create-diff-existing')
                        @else
                            @include('barang-persediaan.create-diff-baru')
                        @endif
