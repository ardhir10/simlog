    ...
    <div class="col-lg-3">
        <div class="form-group">
            <label for=""><strong>Kategori Barang</strong></label>
              <select name="kategori_barang_id" class="form-select select2" required readonly>
...
<div class="row mb-3">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <select name="satuan_id"  class="form-select select2" required readonly>
    ...
    <div class="col-lg-3">
     ...
     <div class="col-lg-3">
        <div class="form-group">
            ...
            <input type="number"  class="form-control" name="jumlah_stok_minimal" value="{{$data->jumlah_stok_minimal}}">
        </div>
    </div>
</div>
