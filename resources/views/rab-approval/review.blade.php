                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-block mb-3">
                                    <h5 class="mb-2">{{$data->nomor_rab}} | {{date('d F Y',strtotime($data->timestamp))}}</h5>
                                    <div class="row mb-3">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <span class="d-block text-success">MAK</span>
                                            <span class="d-block">{{$data->mak}}</span>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <span class="d-block text-success">Tahun Anggaran</span>
                                        ...
                                        <div class="table-responsive">
                                            <table class=" table-striped datatables w-100" id="data-table">
                                                ...
                                                <tr style="">
                                                    ...
                                                    <td class="font-size-15">{{$bd->harga_satuan}}</td>
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <span class="d-block"
                                                            style="font-size:20px;font-weight:bold;">RAB</span>
                                                        <a href="{{route('rab.cetak-rab',$data->id)}}"
                                                            target="_blank">
                                                        ...
                                                        <div class="card" style="border: 1px solid">
                                                            <div class="card-body p-4">
                                                                <p class="text-muted">
                                                                    ...
                                                                    <span class="d-block mb-2">Disetujui oleh {{$appvs->user->role->name ?? ''}}</span>
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{route('rab.approval-tindak-lanjut',$data->id)}}" method="post">
                    @csrf
