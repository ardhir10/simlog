        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class=" animate__animated  animate__fadeIn" id="formInternalUser">
                    ...
                    <div class="form-group mb-2">
                        <label class="form-label" for=""><strong>Kapal Negara</strong></label>
                        <select name="kapal_negara_id" id="" class="form-select" required>
                            <option value="">-- PILIH KAPAL NEGARA</option>
                            @foreach ($kapal_negara as $item)
                                <option {{$data->kapal_negara_id == $item->id ? 'selected=selected' :''}}  value="{{$item->id}}">{{$item->nama_kapal}}</option>
                            @endforeach
                        </select>
                    </div>
